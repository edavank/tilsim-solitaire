...
export const LEVELS = [
  ...
  // Bölüm 9-10: 5 kat × 5 kel
  {
    ...
    categories: [
      ...
      { name: 'Tatil', words: ['Otel', 'Bavul', 'Pasaport', 'Harita', 'Valiz'] },
...
// v1.0.4: 210 → 220 (toplam 230 seviye, 23 bölüm)
const GENERATED_TR = generateLevels(11, 220, 'tr', LEVEL10_CATS);
...
export function getLevel(id, language = 'tr') {
  ...
  const key = language;
  if (!langCache[key]) {
    langCache[key] = generateLevels(1, 230, language);
  }
